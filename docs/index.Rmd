...
---
background-image: url("capa_agosto.png")
...
getSymbols("USDBRL=X", scr = "yahoo", from = "2020-01-01", to = "2021-07-31")
...
ggplot(comex) + 
  ...
  scale_x_date(date_labels = "%b\n%Y", breaks = "1 months", labels = date_format("%b\n%y"), 
               limits = as.Date(c("2020-01-01","2021-07-10"))) +
  theme_minimal() +
  theme(legend.position = "bottom",
        axis.title.y = element_text(size=8),
        plot.title = element_text(size=12, hjust = 0.5, face="bold"),
...
knitr::kable(head(produtos_export),
             ...
             col.names = c("Produto",
                           "Valor exportado em Julho/21 (US$)",
                           "Variação (12 meses)",
                           "Variação mensal"),
             caption = "Produtos mais exportados no mês (Referência: Julho/2021)") %>% 
...
knitr::kable(head(produtos_import),
             ...
             align = "c",
             col.names = c("Produto",
                           "Valor importado em Julho/21 (US$)",
                           "Variação (12 meses)",
                           "Variação mensal"),
             caption = "Produtos mais importados no mês (Referência: Julho/2021)") %>% 
               kable_styling(font_size = 11) 
